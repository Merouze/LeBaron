        ...
        <ul>
            <?php foreach ($resultats as $resultat) : ?>
                ...
                foreach ($resultats as $resultat) {
                    ...
                    echo '</div>';
                    echo '<div>';
                    echo '<p class="obituary-cta"><a class="cta-obituary" href="see-avis.php?idDefunt=' . urlencode($resultat['id_defunt']) . '">Consulter +</a></p>';
                    echo '<p class="obituary-cta"><a class="cta-obituary" href="modif-avis.php?idDefunt=' . urlencode($resultat['id_defunt']) . '">Modifier l\'avis de décès</a></p>';
                    echo '<p class="obituary-cta"><a class="cta-obituary" href="javascript:void(0);" onclick="confirmDelete(' . $resultat['id_defunt'] . ');">Supprimer l\'avis de décès</a></p>';
...
<section class="display-ad">
    ...
    foreach ($lastAvis as $avis) {
        ...
        echo '<p class="obituary-cta"><a class="cta-obituary" href="modif-avis.php?idDefunt=' . urlencode($avis['id_defunt']) . '">Modifier l\'avis de décès</a></p>';
        echo '<p class="obituary-cta"><a class="cta-obituary" href="javascript:void(0);" onclick="confirmDelete(' . $avis['id_defunt'] . ');">Supprimer l\'avis de décès</a></p>';
        echo '</div>';
        echo '</div>';
        echo '</ul>';
        echo '</li>';
