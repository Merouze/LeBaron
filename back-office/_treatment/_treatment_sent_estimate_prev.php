...
// }
        ...
        // Vérifiez si le formulaire a été soumis
        if (isset($idEstimatePrev) && $idEstimate == $idEstimateF) {
            // Obtenez le contenu du PDF depuis la session
            $pdfPath = $_SESSION['pdf_content_' . $idEstimatePrev];
            // var_dump($_POST);
            // exit;
                    ...
                    [
                        ...
                        'Attachments' => [
                            [
                                ...
                                'Filename' => 'Devis-n°' . $idEstimatePrev . '.pdf',
            ...
            $sqlEstimate = $dtLb->prepare("UPDATE estimate_prev SET is_sent = 1 WHERE id_estimate = :id_estimate");
