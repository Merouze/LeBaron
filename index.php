...
<section class="content">
    <div class="text-img">
        ...
        <div class="text">
            ...
            <p>Chaque jour, les <span class="grey bold">Pompes Funèbres</span> <span class="blue bold">Le Baron</span> vous accompagne, dans la prise en charge et <span class="blue bold">l'organisation des obsèques</span> de vos proches dans <span class="grey bold">le respect de vos choix et vos croyances.</span>
            </p>
            <p>À l'écoute des familles endeuillées, nos conseillers funéraires vous
                aident à <span class="grey bold">organiser des obsèques personnalisées,</span> adaptées à votre
                situation, à vos souhaits et à votre budget. Notre objectif est de vous
                accompagner dans la dignité et en toute <span class="blue bold">transparence.</span>
            </p>
        </div>
    </div>
    <div class="text-img">
