...
<section class="devis">
    ...
    <form action="#" method="post" id="devis-form">
        ...
        <label>
            <input class="input-radio" type="radio" name="type-works" value="création-pose" required>
            Création et pose
        </label>
        <label>
            <input class="input-radio" type="radio" name="type-works" value="restauration-modification" required>
            Restauration / Modification
        </label>
        <label>

            <input class="input-radio" type="radio" name="type-works" value="gravure" required>
